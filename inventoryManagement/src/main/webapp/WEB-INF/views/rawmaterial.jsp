...
<body>
<form action="addraw" style="border:1px solid #ccc" method="post">
  <div class="container">
  <center>
    ...
    <input type="text" placeholder="Enter Unit(pcs,kg,gm)" name="unit" required>
    
    <label for="psw"><b>Enter Cost per Unit</b></label>
    <input type="text" placeholder="Enter Cost" name="rcostPerUnit" required>
